...
export const ServiceBookingsPage = () => {
  const control = useVM<ServiceBookingsPageVM>(new ServiceBookingsPageVM())
          ...
          <Row className='py-3 justify-content-center'>
            <Col lg={10} className='p-0'>
              ...
              <div className='d-flex px-2'>
                <div className='d-flex color-I c-pointer'
                  onClick={()=>{
                    Globals.popup.open({
...
export class ServiceBookingsPageVM extends PaginatedListVM<serviceBooking>{
  constructor(){
    super(ServiceBookingClient , false )
  }
  ...
  public getLists(){
    this.loading(async()=>{
      ...
      let response = await BookingClient.getPage(1)
      if(response){
         this.data = response 
      }
      this.update()

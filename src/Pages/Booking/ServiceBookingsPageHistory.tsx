...
export const ServiceBookingsPageHistory = () => {
  const control = useVM<ServiceBookingsPageHistoryVM>(new ServiceBookingsPageHistoryVM())
  const location = useLocation()
  useEffect(()=>{ control.getLists() },[])

  const EditItem = (props:{booking:serviceBooking})=>{
    const [name, setName] = useState(props.booking.name)
    const [mobile, setMobile] = useState(props.booking.mobile)
    const [whatsapp, setWhatsapp] = useState(props.booking.whatsapp)
    ...
    const save = async()=>{
      const data = {...props.booking,name:name,mobile:mobile,whatsapp:whatsapp,additional:additional,discount:discount,paid:paid,status:status,isDone:isDone,notes:notes}
      Globals.popup.close()
      ...
      <Container>
        <div className='p-2 py-3'>
          <div className='row border  p-1'>
            ...
            <div className='col-md-6 col-12 p-2 d-flex justify-content-center'>
              {props.booking.branch_employee_service?.branch_employee?.branch?.name}
            </div>
            <div className='col-md-6 col-12 p-2 d-flex justify-content-center'>
              {props.booking.branch_employee_service?.branch_employee?.employee?.name}
            </div>
            <div className='col-md-6 col-12 p-2 d-flex justify-content-center'>
        ...
        <div className='p-2 row'>
              ...
              <div className='col-md-6 col-12 p-2 d-flex justify-content-center'> 
                <CustomSelect 
                  list={[{label:'تم الحصول على الخدمة', value:'1'},{label:'لم يتم الحصول على الخدمة', value:'0'}]} 
                          ...
                          <div className='p-1 text-center'>
                            <div className='p-1  border rounded-3'>
                                  ...
                                  <div className='row py-2'>
                                    ...
                                    <div className='col-sm-6 col-12 d-flex'>
                                      <div className='my-auto w-100'>
                                        {item.branch_employee_service?.branch_employee?.employee?.name}
                                      </div>
                                    </div>
                                  </div>
                                  <div className='row py-2'>
                            ...
                            <div className='p-1  border rounded-3'>
                              ...
                              <div className=' col-md-auto col-12 justify-content-md-end justify-content-center my-auto'>
                                <div className='row d-flex my-auto'>
                                  ...
                                  <div className='color-gray p-2 col-md-auto col-12 my-auto'>
                                    {item.is_done == 1?'تم الحصول على الخدمة':'لم يتم الحصول على الخدمة'} 
                                  </div>
                            ...
                            <div className='d-flex flex-column justify-content-between h-100'>
                              ...
                              <div className='d-flex justify-content-center'>
                                <div className='button-I btn-clr-I c-pointer px-3 py-1 fs-6' onClick={()=>{
                                  control.updateItem({...item,is_done:1})
                                  Globals.popup.close()
                                  control.getPage()
                                }}>
                                  موافق
                              ...
                              <div className='row g-2 py-2'>
                                <div className='col-lg-6 col-12  my-auto'>
                                  <div className='row g-2 w-100'>
                                    ...
                                    <div className='col-sm-6 col-12  my-auto'>
                                    {item.branch_employee_service?.branch_employee?.branch?.name}
                                    </div>
                                  </div>
                                </div>
                                <div className='col-lg-6 col-12 my-auto'>
...
export class ServiceBookingsPageHistoryVM extends PaginatedListVM<serviceBooking>{
  constructor(){
    super(ServiceBookingClient , true )
  }
  ...
  public async updateItem(item:serviceBooking , onFail?:()=>void){
    const response = await new ServiceBookingClient().insert(item)
